...
Now we are ready for batch annotation using `mapProteinFeaturesToEvents()`. The function retrieves the latest annotation from the public UniprotKB FTP, and overlaps splice events to genomic coordinates of protein features. UniprotKB features are grouped into categories.  
